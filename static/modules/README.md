...
`/lores`에서 로어를 연 뒤 **세계관·인물 모듈**에서 파일을 설치합니다. 설치와 동시에 그 로어에 적용되며, 같은 곳에서 켜거나 끌 수 있습니다. 파일 내용은 선택한 로어의 SQLite 진행에 저장됩니다. 모듈 파일을 옮겨도 계속 사용할 수 있습니다. 로어 전체를 옮기는 JSON 파일은 이 모듈 형식과 별도로 `/lores`의 내보내기에서 만듭니다.
