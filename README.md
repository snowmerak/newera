...
- 왼쪽 로어 사이드바에서 세계관과 등장인물을 고르고 내용을 읽을 수 있습니다. 인물을 고르면 행동 대상으로 연결됩니다. 기본 세계관과 인물 설정을 편집하거나 새 성인 인물을 추가할 수도 있습니다. 작은 화면에서는 상단 `로어 보기`를 누릅니다.
- 사이드바 상단 `로어 가져오기 · JSON`에서 세계관과 성인 등장인물 모듈을 설치할 수 있습니다. 목록에서 적용 여부를 보고 전환합니다. 세계관 모듈은 한 번에 하나, 인물 모듈은 여러 개를 켤 수 있습니다. [형식과 예시](static/modules/README.md)를 참고하세요. 모듈을 꺼도 인물의 진행과 기억은 유지됩니다.
